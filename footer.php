...
<body>
  <footer id="page-footer" class="content-info" role="contentinfo">
          ...
          <div class="contact-col contact-right col-md-6">
            <div role="form" class="contact-f" id="contact-f" lang="en-US" dir="ltr">
              ...
              <form action="#" method="post" class="contact-f-form" novalidate="novalidate">
                <div class="input">
                  <input type="text" name="fullname" value="" size="40" class="contact-f-form-control contact-f-text contact-f-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Name">
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <input type="email" name="email" value="" size="40" class="contact-f-form-control contact-f-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email Address">
                  </div>
                  <div class="col-sm-6">
                    <input type="tel" name="telephone" value="" size="40" class="contact-f-form-control contact-f-validates-as-tel" aria-invalid="false" placeholder="Phone Number">
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <input type="text" name="address" value="" size="40" class="contact-f-form-control contact-f-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Adress, City,Zip Code">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="textarea-message">
                  <textarea name="message" cols="40" rows="10" class="contact-f-form-control contact-f-textarea" placeholder="Message">
                                </textarea>
                </div>

                <input type="submit" value="SEND" class="contact-f-form-control contact-f-submit"><input type="hidden" class="contact-f-pum" value="">
    ...
    <div id="footer-copyright">
      <div class="row">
        <div id="copyright-bar" class="col-lg-12"><span>© Helmuth Builders. All rights reserved. <a href="#">FAQs</a></span>
